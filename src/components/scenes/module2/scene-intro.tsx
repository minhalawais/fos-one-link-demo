      ...
      <div className="relative z-10 flex flex-col items-center justify-center">
        ...
        <div className="relative mb-6">
          <motion.div
            ...
            className="relative z-20 w-24 h-24 bg-gradient-to-br from-[#284952] to-[#1a2e33] rounded-[1.75rem] shadow-2xl shadow-[#284952]/30 flex items-center justify-center text-white"
          >
          ...
          {/* Ripple Effect */}
          <motion.div
            className="absolute inset-0 bg-[#284952]/10 rounded-[1.75rem] blur-xl"
        ...
        <div className="text-center space-y-2">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-base font-medium text-[#767676]">Quickly</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-1.5 h-1.5 rounded-full bg-[#60BA81]" />
              <span className="text-base font-medium text-[#767676]">Safely</span>
            </div>
          </motion.div>
        </div>
      </div>
